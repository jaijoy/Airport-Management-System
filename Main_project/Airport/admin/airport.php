...
<div class="container">
  ...
  font-weight: 700;
  background-image: linear-gradient(to left, blue, #b393d3);
  color: transparent;
  background-clip: text;
  -webkit-background-clip: text;">Airport Details</h1></center>
...
<button style="margin-left: 81%;" onclick="openForm()"> +Add Airport</button>
