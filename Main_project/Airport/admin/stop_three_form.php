...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($row[0] > 0) {
        ...
        two_stop_name, two_stop_layover_duration, three_stop_name, three_stop_layover_duration) 
        VALUES ('$flight_id', '$departure_location', '$layover_duration', '$departure_location2', '$layover_duration2', '$departure_location3', '$layover_duration3')";
