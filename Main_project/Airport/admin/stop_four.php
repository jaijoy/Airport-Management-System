        ...
        <main>
            ...
            if ($result) {
                ...
                <div class="container2">
                    <h2 class="mb-4">Flights : Four Stop</h2>
                    <div class="row">
                        <?php
                        $count = 0;
                            ...
                            <div class="col-md-4">
                                <div class="card mx-auto">
                                    <div class="card-body">
                                        ...
                                        <a href="stop_four_form.php?flight_id=<?php echo $row['flight_id']; ?>" class="btn btn-primary btn-add-details">Add Four Stop Details</a>
                                    </div>
                                </div>
                            </div>
                            <?php
