        ...
        <main>
            ...
            if ($result) {
                ...
                <div class="container2">
                    <h2 class="mb-4">Flights : Two Stop</h2>
                    <div class="row">
                        <?php
                        $count = 0;
                            ...
                            <div class="col-md-4">
                                <div class="card mx-auto">
                                    <div class="card-body">
                                        ...
                                        <a href="stop_two_form.php?flight_id=<?php echo $row['flight_id']; ?>" class="btn btn-primary btn-add-details">Add Two Stop Details</a>
                                    </div>
                                </div>
                            </div>
                            <?php
