...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_query = "SELECT COUNT(*) FROM twostop WHERE flight_id = '$flight_id'";
    ...
    if ($row[0] > 0) {
        ...
        $insert_query = "INSERT INTO twostop (flight_id, f_duration, f_stop, s_duration, s_stop) 
                         VALUES ('$flight_id', '$layover_duration', '$departure_location', '$layover_duration2', '$departure_location2')";
